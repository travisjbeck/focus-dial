...
bool NetworkController::isWiFiProvisioned()
{
  ...
  Serial.println("NetworkController::isWiFiProvisioned - TEMPORARILY RETURNING TRUE FOR PROJECT SELECT STATE TEST");
  return true; // Temporarily force true for testing ProjectSelectState UI
}
